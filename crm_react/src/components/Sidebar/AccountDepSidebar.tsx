...
const AccountDepSidebar = () => {
  const menuItems = [
    {
      id: 1,
      name: "Dashboard",
      path: "/accountdepartment/dashboard",
    ...
    },
    {
      id: 2,
      name: "Manage Folders",
      path: "/accountdepartment/managefolder",
    ...
    },
    {
      id: 3,
      name: "Payments",
      path: "/accountdepartment/payments",
    ...
    },
    {
      id: 4,
      name: "Companies",
      path: "/accountdepartment/companies",
    ...
    },
    {
      id: 6,
      name: "Reports",
      path: "/accountdepartment/reports",
      white: "/Reports_w.svg",
      black: "/Reports_b.svg",
    },
    {
      id: 7,
      name: "Settings",
      path: "/accountdepartment/settings",
...
export default AccountDepSidebar